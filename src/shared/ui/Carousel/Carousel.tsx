...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div ref={carouselRef} className="overflow-hidden xs:-mx-5 xs:px-5 lg:px-7 lg:mx-9">
      <div
        ref={ref}
        className={cn(
          "flex",
